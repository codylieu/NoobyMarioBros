...
public class SpaceRunIII extends StdGame {
                                ...
                                if (firstpart>0) {
                                        ...
                                        if (random(0,5) < 1)
                                                new JGObject("pod",true,tileWidth()*x,
                                                        ...
                                                        4, "egg", 0,0,14,14, 0,0, JGObject.suspend_off_view);
                                        oldpos = tunnelpos;
                ...
                case 1:
                        ...
                        for (int i=0; i<5+level/2; i++) {
                                ...
                                new JGObject("pod",true,random(pfWidth()/2,pfWidth()),
                                        random(0,pfHeight()),
                                        4, "egg", 0,0,14,14, 0,random(0.5,1.2), -1);
                        }
                break; }
        ...
        public class Player extends JGObject {
                public Player(double x,double y,double speed) {
                        super("player",false,x,y,1,"shipu",0,0,speed,speed,-1);
                }
                public void move() {
                        setDir(0,0);
